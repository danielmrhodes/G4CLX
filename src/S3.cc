...
void S3::Placement(G4LogicalVolume* world, G4double USoff, G4double DSoff, G4bool check) {
  ...
  new G4PVPlacement(0,G4ThreeVector(0,0,DSoff),pcb_holderL,"pcbH",world,false,1,check);
  new G4PVPlacement(0,G4ThreeVector(0,0,-USoff),pcb_holderL,"pcbH",world,false,0,check);
  ...
  new G4PVPlacement(0,G4ThreeVector(),pipeL,"pipe",world,false,0,check);
  */
